...
class CustomPageNumberPagination(PageNumberPagination):
    ...
    to customize the pagination behavior. It sets a default page size, specifies
    ...
    page_query_param : str
        The query parameter name for specifying the page number. Default is 'page'.
    page_size_query_param : str
        The query parameter name for specifying the number of items per page. Default is 'limit'.
    max_page_size : int
        The maximum number of items that can be requested per page. Default is 100.
    """
    page_size: int = 10
